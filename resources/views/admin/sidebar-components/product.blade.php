...
<div class="container cover">
    ...
    @php $no++; $id_product = $product->id_product @endphp
    <form action="{{ route('handle-Product', $id_product) }}" method="post">@csrf
    <div class="row select_all add_new_hide">
        ...
        <div class="col text-center">
            <div class="content">
                @if($product->homepage == 0) <input class="circle_ _red" type="submit" name="btnHomepage">
                @else <input class="circle_ _green" type="submit" name="btnHomepage"> @endif
            </div>
        </div>
        <div class="col text-center">
            <div class="content">
                @if($product->display == 0) <input class="circle_ _red" type="submit" name="btnDisplay">
        ...
        {{-- checkboxes --}}
        <input class="form-check-input checkbox-tick" type="checkbox" name="ckbTick" value="{{ $id_product }}">
    </div>
    </form>
    @endforeach
