...
<div class="container cover">
    ...
    @php $no++; $id_blog = $blog->id_blog @endphp
    <form action="{{ route('handle-Blog', $id_blog) }}" method="post">@csrf
    <div class="row select_all add_new_hide">
        ...
        <div class="col text-center">
            <div class="content">
                @if($blog->homepage == 0) <input class="circle_ _red" type="submit" name="btnHomepage">
                @else <input class="circle_ _green" type="submit" name="btnHomepage"> @endif
            </div>
        </div>
        <div class="col text-center">
            <div class="content">
                @if($blog->display == 0) <input class="circle_ _red" type="submit" name="btnDisplay">
        ...
        {{-- checkboxes --}}
        <input class="form-check-input checkbox-tick" type="checkbox" name="ckbTick" value="{{ $id_blog }}">
    </div>
    </form>
    @endforeach
