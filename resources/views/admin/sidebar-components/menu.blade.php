...
<div class="container cover">
    ...
    <form action="{{ route('handle-Menu', $id_menu) }}" method="post">@csrf
    <div class="row select_all add_new_hide">
        ...
        <div class="col text-center">
            <div class="content">
                @if($menu->homepage == 0) <input class="circle_ _red" type="submit" name="btnHomepage">
                @else <input class="circle_ _green" type="submit" name="btnHomepage"> @endif
            </div>
        </div>
        <div class="col text-center">
            <div class="content">
                @if($menu->display == 0) <input class="circle_ _red" type="submit" name="btnDisplay">
