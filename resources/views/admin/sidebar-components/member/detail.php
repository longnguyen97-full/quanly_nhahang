...
<div class="container cover">
    ...
    <form action="{{ route('handleWidget', $id_widget) }}" method="post">@csrf
    <div class="row select_all">
        ...
        <div class="col text-center">
            <div class="content">@if($widget->display == 0) <div class="circle_ _red"></div> @else <div class="circle_ _green"></div> @endif</div>
        </div>
        <div class="col text-center">
            <div class="content">
