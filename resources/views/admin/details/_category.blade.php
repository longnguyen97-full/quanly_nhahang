...
<div class="container cover">
    ...
    <form action="{{ route('handle-Menu', $_menu->id_menu) }}" method="post">@csrf
    <div class="row select_all add_new_hide">
        <div class="col">
            <div class="content">
                <img id="blah-detail" src="{{ asset($_menu->image) }}" alt="" width="300px">
        ...
        <div class="col">
            <div class="content">
                <div class="form-group">
                    <label>Title</label>
                    <input type="text" class="form-control" name="txtTitle" placeholder="{{ $_menu->name }}" disabled>
                </div>
                <div class="form-group">
                    <label>Description</label>
                    <input type="text" class="form-control" name="txtDescription" placeholder="{{ $_menu->description }}" disabled>
                </div>
            </div>
        </div>
    </div>
